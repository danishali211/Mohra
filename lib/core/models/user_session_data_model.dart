...
class UserSessionDataModel {
  ...
  static updateProfileSP(
    ...
    imageUrl = new_image;
    gender = new_gender;
    birthday = new_date != null ? DateTimeHelper.getStringDateInEnglish(new_date) : "";
    var sp = await SpUtil.getInstance();
  ...
  static Future<void> updateProfileData(
    ...
    birthday = getProfileEntity.birthDate != null ?DateTimeHelper.getFormatedDate(getProfileEntity.birthDate) : null;
