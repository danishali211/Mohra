...
import 'package:starter_application/core/firebase/notification_middleware.dart';
...
_initAppConfigs() async {
  ...
  try {
    AppsFlyerOptions appsFlyerOptions = AppsFlyerOptions(
        ...
        // for iOS 14.5
        appInviteOneLink: "https://onelink.to/rtrak8",
        // Optional field
  ...
  //   NotificationChannel(
  //     channelKey: AppConstants.BASIC_CHANNEL,
  ...
  /* await flutterLocalNotificationsPlugin.initialize(
    ...
    onSelectNotification: (payload) {
      if (Provider.of<CallScreenNotifier>(
