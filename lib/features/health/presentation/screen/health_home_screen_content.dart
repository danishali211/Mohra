    ...
    return Column(
      children: [
        ...
        _buildItem(
          ...
          subtitle: "${sn.healthDashboardEntity.intakeKcal}/${(sn.healthDashboardEntity.totalValueOfCalories).toStringAsFixed(0)} ${Translation.current.calories}",
          percent: sn.healthDashboardEntity.intakeKcal/sn.healthDashboardEntity.totalValueOfCalories,
