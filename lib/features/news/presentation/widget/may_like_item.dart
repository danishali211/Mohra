                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image:
                                    (widget.icon != "string" && widget.image.isNotEmpty)
                                        ? DecorationImage(
                                      image: NetworkImage(
                                        widget.icon,
                                      ),
                            ...
                            Text(
                              timeago.format("".setTime(DateTime.tryParse(widget.date)!.toLocal().toString()),locale: "ar",clock: DateTime.now()),
                              style: TextStyle(
                                  fontSize: 30.sp, color: Colors.white,overflow:TextOverflow.ellipsis),
                            ),
                          ],
                        ),
                        Gaps.vGap12,
