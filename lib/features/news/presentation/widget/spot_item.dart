...
class SpotNewsItem extends StatefulWidget {
  const SpotNewsItem({Key? key,required this.image,required this.title,required this.icon, required this.iconName,required this.onTap, required this.date}) : super(key: key);
  final String image;
  final String icon;
                        ...
                        children: [
                          Container(
                            ...
                            decoration:  BoxDecoration(
                              shape:
                              BoxShape.circle,
                              image:(widget.icon !="string"&&widget.image.isNotEmpty)?
                              DecorationImage(
                                image: NetworkImage(
                                  widget.icon,
                                ),
