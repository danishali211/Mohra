...
class NewsSubCategoryScreen extends StatefulWidget {
  ...
  const NewsSubCategoryScreen({Key? key,required this.entity}) : super(key: key);
...
class _NewsSubCategoryScreenState extends State<NewsSubCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    return Directionality(
      textDirection: TextDirection.rtl,child: ChangeNotifierProvider<SingleCategoryScreenNotifier>.value(
          value: sn,
          child: BlocConsumer<NewsCubit, NewsState>(
            bloc: sn.newsCubit,
            builder: (context, state) {
              return state is NewsLoadingState ? Container(
                  color: Colors.white,
                  child: WaitingWidget()) :
              Scaffold(
