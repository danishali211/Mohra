...
class SingleMessageScreenContent extends StatefulWidget {
  ...
  const SingleMessageScreenContent({Key? key,
...
class _SingleMessageScreenContentState
                  ...
                  Row(
                    ...
                    children: [
                      IconButton(
                        alignment: Alignment.center,
                        onPressed: () {
                          context.read<AppMainScreenNotifier>()
                              .updateSelectedIndex();
                          Nav.pop();
                        },
                        icon: Icon(
  ...
  Widget _buildContent() {
    ...
    if (sn.params.isGroup) {
      RoomEntity room =
      Provider
          .of<GlobalMessagesNotifier>(context, listen: true)
          .groups
          .firstWhere(
            (element) =>
  ...
  _buildMoreOptionItem(String icon, String text, Color color,
