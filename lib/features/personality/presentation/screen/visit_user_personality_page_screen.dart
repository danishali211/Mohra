...
class VisitUserPersonalityPageScreen extends StatefulWidget {
  ...
  const VisitUserPersonalityPageScreen({Key? key,required this.params}) : super(key: key);

  @override
  _VisitUserPersonalityPageScreenState createState() => _VisitUserPersonalityPageScreenState();
}

class _VisitUserPersonalityPageScreenState extends State<VisitUserPersonalityPageScreen> {
  VisitUserPersonalityPageScreenNotifier sn = VisitUserPersonalityPageScreenNotifier();
            ...
            child: Scaffold(
              ...
              body: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: VisitUserPersonalityPageScreenContent(name: widget.params.name ,),
                  ),
                ],
              ),
