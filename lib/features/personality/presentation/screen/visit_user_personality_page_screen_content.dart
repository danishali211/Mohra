...
للتحميل من هنا🔗
https://onelink.to/rtrak8
''';

   VisitUserPersonalityPageScreenContent({Key? key, this.name}) : super(key: key);
  @override
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      child: Row(
                        children: [
                          Text(Translation.current.Share_my_character,style: const TextStyle(
                              color: AppColors.mansourBackArrowColor2
                          ),),
                          const Icon(Icons.share,color: AppColors.mansourBackArrowColor2,),
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child:  SelectableText(
                        "https://onelink.to/rtrak8",
                        textAlign: AppConfig().isLTR ? TextAlign.left : TextAlign.right,
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildPersonalityResultCard() {
    ...
    return PersonalityResultCard(
      ...
      content: "${isArabic ? sn.avatarEntity.arDescription : sn.avatarEntity.enDescription}",
