                                      ...
                                      return Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Gaps.vGap16,
                                            buildEditImageCard(
                                              text: Translation.of(context).view_all_my_moments,
                                              onTap: () {
                                                Nav.pop();
                                              ...
                                              icon: AppConstants.SVG_MOMENT_FILL,
                                            ),
                                            Gaps.vGap8,
                                            buildEditImageCard(
                                              text: Translation.of(context).Change_Profile_Photo,
                                              onTap: () {
                                                Nav.pop();
    ...
    return BlocConsumer<MomentCubit, MomentState>(
      ...
      listener: (context, state) {
        if (state is DeletePostSuccess) {
          sn.onDeleteSuccess();
          Toast.show(Translation.current.post_was_deleted_successfully,duration: 600);
        } else if (state is ReportPostSuccess) {
          sn.onReportSuccess();
          Toast.show(Translation.current.post_was_reported_successfully,duration: 600);
        }
      },
      builder: (context, state) {
