...
class _AppMainScreenState extends State<AppMainScreen>
  ...
  void initState() {
    ...
    _timer = Timer.periodic(const Duration(milliseconds: 1000), (timer) {
      ...
      // BlocProvider.of<GlogalCubit>(context, listen: false).getCall();
    });
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    ...
    if (state == AppLifecycleState.resumed) {
      ...
      // You can add your logic here for when the app is put in the background.
      // For example, stop background music or save user progress.
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDrawerItem(
              AppConstants.SVG_MY_LIFE, Translation.current.profile, onTap: () {
            Nav.to(ViewProfileScreen.routeName)
                .then((value) => sn.notifyListeners());
          }),
          _buildDrawerItem(
          ...
          _buildDrawerItem(
              AppConstants.NOTIFICATION_ICON, Translation.current.notification,
              onTap: () {
            Nav.to(
          ...
          _buildDrawerItem(
              'assets/images/svg/setting_icon.svg', Translation.current.setting,
              onTap: () {
            Nav.to(SettingMainScreen.routeName);
          }),
          _buildDrawerItem(
              AppConstants.SVG_CONTACT_US, Translation.current.help, onTap: () {
