...
class RegisterWithGoogleScreenNotifier extends ScreenNotifier {
 ...
 bool canRegister(){
    String phoneNumber = phoneController.text[0] == '0' ? phoneController.text.substring(1) :phoneController.text;
    if(nameController.text.isNotEmpty && lastNameController.text.isNotEmpty && date != null && userNameController.text.isNotEmpty && phoneNumber.length >=9){
      return true;
    }
    return false;
  }
