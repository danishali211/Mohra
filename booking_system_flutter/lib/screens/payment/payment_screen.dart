                                    ...
                                    builder: (context) {
                                      return Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text("${language.lblPayWith} ${currentPaymentMethod!.title.validate()}?", style: boldTextStyle(size: 20)),
                                            16.height,
                                            Row(
                                              children: [
                                                AppButton(
                                    ...
                                    builder: (context) {
                                      return Container(
                                        ...
                                        child: Column(
                                          ...
                                          mainAxisSize: MainAxisSize.min,
                                          children: [
                                            Text(language.doYouWantToTopUpYourWallet, style: boldTextStyle(size: 20)),
                                            16.height,
                                            Row(
                                              children: [
                                                AppButton(
